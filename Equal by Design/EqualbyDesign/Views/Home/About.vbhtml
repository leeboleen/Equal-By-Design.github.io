            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="project-item">
                    <a href="images/project-image1.jpg" class="image-popup">
                        <img src="~/Content/Content/images/project-image1.jpg" class="img-responsive" alt="">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="project-item">
                    <a href="images/project-image3.jpg" class="image-popup">
                        <img src="~/Content/images/project-image3.jpg" class="img-responsive" alt="">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="project-item">
                    <a href="images/project-image4.jpg" class="image-popup">
                        <img src="~/Content/images/project-image4.jpg" class="img-responsive" alt="">
        ...
        <div class="row">
            ...
            <div id="owl-team" class="owl-carousel">
                <div class="col-md-4 col-sm-4 item">
                    <div class="team-item">
                        <img src="~/Content/images/team-image1.jpg" class="img-responsive" alt="">
                ...
                <div class="col-md-4 col-sm-4 item">
                    <div class="team-item">
                        <img src="~/Content/images/team-image2.jpg" class="img-responsive" alt="">
                        <div class="team-overlay">
                            <ul class="social-icon">
                ...
                <div class="col-md-4 col-sm-4 item">
                    <div class="team-item">
                        <img src="~/Content/images/team-image3.jpg" class="img-responsive" alt="">
                        <div class="team-overlay">
                            <ul class="social-icon">
                                <li><a href="#" class="fa fa-instagram"></a></li>
                ...
                <div class="col-md-4 col-sm-4 item">
                    <div class="team-item">
                        <img src="~/Content/images/team-image4.jpg" class="img-responsive" alt="">
                        <div class="team-overlay">
                            <ul class="social-icon">
                                <li><a href="#" class="fa fa-twitter"></a></li>
                                <li><a href="#" class="fa fa-facebook"></a></li>
